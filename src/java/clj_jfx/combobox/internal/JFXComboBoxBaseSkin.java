 ...
 */
public abstract class JFXComboBoxBaseSkin<T> extends SkinBase<ComboBoxBase<T>> {
    ...
    private JFXComboBoxMode mode = JFXComboBoxMode.COMBOBOX;
    final JFXComboBoxMode getMode() { return mode; }
    final void setMode(JFXComboBoxMode value) { mode = value; }
    ...
    /**
     * Creates a new instance of JFXComboBoxBaseSkin, although note that this
     * instance does not handle any behavior / input mappings - this needs to be
     * handled appropriately by subclasses.
     *
     * @param control The control that this skin should be installed onto.
     */
    public JFXComboBoxBaseSkin(final ComboBoxBase<T> control) {
    ...
    private boolean isButton() {
        return getMode() == JFXComboBoxMode.BUTTON;
    }
