...
package clj_jfx.combobox.internal;
...
/**
 * An abstract class that extends the functionality of {@link javafx.scene.control.skin.ComboBoxBaseSkin}
 * to include API related to showing ComboBox-like controls as popups.
 *
 * @param <T> The type of the ComboBox-like control.
 * @since 9
 */
public abstract class JFXComboBoxPopupControl<T> extends JFXComboBoxBaseSkin<T> {
    ...
    protected abstract ComboBoxBaseBehavior getMyBehavior();
     ...
     */
    public JFXComboBoxPopupControl(ComboBoxBase<T> control) {
        super(control);
    ...
    private void createPopup() {
        popup = new PopupControl() {
            @Override public Styleable getStyleableParent() {
                return JFXComboBoxPopupControl.this.getSkinnable();
            }
            {
                setSkin(new Skin<Skinnable>() {
                    @Override public Skinnable getSkinnable() { return JFXComboBoxPopupControl.this.getSkinnable(); }
